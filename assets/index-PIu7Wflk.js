const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Resources-acdIO3RF.js","assets/vendor-react-BTW_75ak.js","assets/vendor-supabase-DS4euJVY.js","assets/Resources-Da2drgDA.css","assets/Privacy-C0AXB575.js","assets/MyHistory-65hILQhN.js","assets/CheckIn-Bx7mJo9t.js","assets/Journal-rM0wYpq2.js","assets/Support-D5nDet55.js","assets/WellnessRoute-dL5qfDI0.js","assets/Companion-C--4E5Uu.js","assets/Library-0wQantDd.js","assets/Emotions-Qcu8i-Hb.js","assets/MapPage-BDp0bkLU.js","assets/Trees-EBaRqvyN.js","assets/Buddy-1gl-mPoH.js","assets/Adventure-CizRmoSo.js","assets/Calendar-Q5A3TU8-.js","assets/Admin-KYBcn7XJ.js","assets/authService-D7-P9Zkr.js","assets/AdminLogin-BZYusDRO.js"])))=>i.map(i=>d[i]);
import{r as t,a as ee,u as z,L as b,N as u,b as U,R as de,c as v,d as B,e as ue,B as me}from"./vendor-react-BTW_75ak.js";import{c as pe}from"./vendor-supabase-DS4euJVY.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const c of r)if(c.type==="childList")for(const l of c.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function n(r){const c={};return r.integrity&&(c.integrity=r.integrity),r.referrerPolicy&&(c.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?c.credentials="include":r.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function i(r){if(r.ep)return;r.ep=!0;const c=n(r);fetch(r.href,c)}})();var ae={exports:{}},R={};/**
 * @license React
 ...
 */var xe=t,he=Symbol.for("react.element"),ge=Symbol.for("react.fragment"),ve=Object.prototype.hasOwnProperty,be=xe.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,fe={key:!0,ref:!0,__self:!0,__source:!0};function se(a,s,n){var i,r={},c=null,l=null;n!==void 0&&(c=""+n),s.key!==void 0&&(c=""+s.key),s.ref!==void 0&&(l=s.ref);for(i in s)ve.call(s,i)&&!fe.hasOwnProperty(i)&&(r[i]=s[i]);if(a&&a.defaultProps)for(i in s=a.defaultProps,s)r[i]===void 0&&(r[i]=s[i]);return{$$typeof:he,type:a,key:c,ref:l,props:r,_owner:be.current}}R.Fragment=ge;R.jsx=se;R.jsxs=se;ae.exports=R;var e=ae.exports,ne,V=ee;ne=V.createRoot,V.hydrateRoot;const je="modulepreload",ye=function(a){return"/sintonia-unam/"+a},H={},j=function(s,n,i){let r=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),m=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));r=Promise.allSettled(n.map(h=>{if(h=ye(h),h in H)return;H[h]=!0;const g=h.endsWith(".css"),p=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${h}"]${p}`))return;const d=document.createElement("link");if(d.rel=g?"stylesheet":je,g||(d.as="script"),d.crossOrigin="",d.href=h,m&&d.setAttribute("nonce",m),document.head.appendChild(d),g)return new Promise((o,x)=>{d.addEventListener("load",o),d.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${h}`)))})}))}function c(l){const m=new Event("vite:preloadError",{cancelable:!0});if(m.payload=l,window.dispatchEvent(m),!m.defaultPrevented)throw l}return r.then(l=>{for(const m of l||[])m.status==="rejected"&&c(m.reason);return s().catch(c)})},W="1.0.0",K={bajo:{max:33},moderado:{max:66}},P={bajo:"Bajo nivel de atención",moderado:"Atención moderada",prioritario:"Atención prioritaria"},S={ANSWERS:"sintonia.answers",CONSENT:"sintonia.consent",RESULT:"sintonia.result",ANON_CODE:"sintonia.anon_code"},ie="generate-orientation",q="sintonia.student";function J(){try{const a=sessionStorage.getItem(q);if(a)return JSON.parse(a);const s=sessionStorage.getItem(S.ANON_CODE);return s?{code:s,password:null}:null}catch{return null}}function _e(a){a?sessionStorage.setItem(q,JSON.stringify(a)):sessionStorage.removeItem(q),window.dispatchEvent(new Event("sintonia:student"))}function Ne(){sessionStorage.removeItem(q),sessionStorage.removeItem(S.ANON_CODE),window.dispatchEvent(new Event("sintonia:student"))}function F(){const[a,s]=t.useState(J),n=t.useCallback(()=>s(J()),[]);return t.useEffect(()=>{const i=()=>n();return window.addEventListener("sintonia:student",i),window.addEventListener("storage",i),()=>{window.removeEventListener("sintonia:student",i),window.removeEventListener("storage",i)}},[n]),{student:a,setStudent:i=>{_e(i),n()},clearStudent:()=>{Ne(),n()}}}function we(){const{student:a,clearStudent:s}=F(),n=!!(a!=null&&a.code),i=z(),[r,c]=t.useState(null),[l,m]=t.useState(!1),h=t.useRef(null);t.useEffect(()=>{c(null),m(!1)},[i.pathname]),t.useEffect(()=>{function x(f){var w;(w=h.current)!=null&&w.contains(f.target)||c(null)}return document.addEventListener("click",x),()=>document.removeEventListener("click",x)},[]),t.useEffect(()=>(document.body.style.overflow=l?"hidden":"",document.body.classList.toggle("drawer-open",l),()=>{document.body.style.overflow="",document.body.classList.remove("drawer-open")}),[l]);function g(x){c(f=>f===x?null:x)}function p(){m(!1)}function d(){m(!1),confirm(`¿Cerrar sesión?
...
Tu código y datos se conservan en el sistema. Solo se borrará tu acceso local — puedes volver con tu código.`)&&(s(),window.location.assign("/sintonia-unam/"))},children:"↩ Cerrar sesión"})]})]}):e.jsx(b,{to:"/consentimiento",className:"btn btn-primary btn-sm nav-cta",children:"Iniciar orientación"})]})]}),l&&ee.createPortal(e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"mobile-overlay",onClick:p}),e.jsxs("aside",{className:"mobile-drawer",role:"dialog","aria-label":"Menú principal",children:[e.jsxs("header",{children:[e.jsx("strong",{children:"Menú"}),e.jsx("button",{className:"close-x",onClick:p,"aria-label":"Cerrar",children:"✕"})]}),n&&e.jsxs("div",{className:"m-user",children:[e.jsx("span",{className:"m-initials",children:o}),e.jsxs("div",{children:[e.jsx("strong",{children:"Tu código"}),e.jsx("code",{children:a.code})]})]}),e.jsxs("nav",{className:"m-nav",children:[e.jsx(u,{to:"/",end:!0,onClick:p,children:"🏠 Inicio"}),e.jsx("h4",{children:"Conocer"}),e.jsx(u,{to:"/recursos",onClick:p,children:"📌 Recursos"}),e.jsx(u,{to:"/calendario",onClick:p,children:"📅 Calendario"}),e.jsx(u,{to:"/mapa",onClick:p,children:"🗺 Mapa"}),e.jsx(u,{to:"/emociones",onClick:p,children:"📖 Emociones"}),e.jsx("h4",{children:"Apoyo"}),e.jsx(u,{to:"/apoyo",onClick:p,children:"🆘 Apoyo y canalización"}),n&&e.jsxs(e.Fragment,{children:[e.jsx("h4",{children:"Mi rincón"}),e.jsx(u,{to:"/mi-historia",onClick:p,children:"📊 Mi panel"}),e.jsx(u,{to:"/check-in",onClick:p,children:"📝 Check-in semanal"}),e.jsx(u,{to:"/diario",onClick:p,children:"📔 Diario"}),e.jsx(u,{to:"/ruta",onClick:p,children:"🛤 Mi ruta"}),e.jsx(u,{to:"/companion",onClick:p,children:"🤝 Pum-AI"}),e.jsx(u,{to:"/biblioteca",onClick:p,children:"📚 Biblioteca"}),e.jsx(u,{to:"/aventura",onClick:p,children:"🗺 Aventura"}),e.jsx(u,{to:"/buddy",onClick:p,children:"🫂 Buddy"}),e.jsx(u,{to:"/arboles",onClick:p,children:"🌳 Mis árboles"})]}),e.jsx("h4",{children:"Información"}),e.jsx(u,{to:"/privacidad",onClick:p,children:"🔒 Privacidad"}),e.jsx("div",{className:"m-cta",children:n?e.jsx("button",{type:"button",className:"btn btn-coral",onClick:d,children:"↩ Cerrar sesión"}):e.jsx(b,{to:"/consentimiento",onClick:p,className:"btn btn-primary btn-lg",children:"Iniciar orientación"})})]})]})]}),document.body)]})}function Se(){const a=new Date().getFullYear();return e.jsx("footer",{className:"site-footer",children:e.jsxs("div",{className:"container",children:[e.jsxs("div",{className:"footer-card",children:[e.jsxs("div",{children:[e.jsx("h4",{children:"Sintonía UNAM"}),e.jsx("p",{children:"Plataforma universitaria de orientación para el bienestar emocional. No constituye diagnóstico ni sustituye atención profesional."})]}),e.jsxs("div",{className:"footer-links",children:[e.jsx(b,{to:"/privacidad",children:"Aviso de privacidad"}),e.jsx(b,{to:"/recursos",children:"Recursos de apoyo"}),e.jsx(b,{to:"/admin",children:"Acceso interno"})]})]}),e.jsxs("p",{className:"footer-credits",children:["© Universidad Nacional Autónoma de México, ",a,"."]})]})})}const O="sintonia.crisis_visible";function ke(){const a=z(),[s,n]=t.useState(!1),[i,r]=t.useState(!1),c=a.pathname.startsWith("/admin")||a.pathname.startsWith("/apoyo");t.useEffect(()=>{try{const m=JSON.parse(sessionStorage.getItem(S.RESULT)||"null");m&&m.general_level==="prioritario"&&localStorage.setItem(O,"1")}catch{}n(localStorage.getItem(O)==="1")},[a.pathname]);function l(){localStorage.setItem(O,"0"),n(!1),r(!1)}return!s||c?null:e.jsxs(e.Fragment,{children:[i&&e.jsxs("div",{className:"crisis-panel",children:[e.jsxs("header",{children:[e.jsx("strong",{children:"🆘 Apoyo inmediato"}),e.jsx("button",{onClick:()=>r(!1),"aria-label":"Cerrar",children:"✕"})]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Línea de la Vida"})," — orientación gratuita, confidencial, 24/7."]}),e.jsx("a",{href:"tel:8002900024",className:"btn btn-coral",children:"📞 800 290 0024"}),e.jsx(b,{to:"/apoyo",className:"btn btn-ghost btn-sm",children:"Ver más opciones"}),e.jsx("button",{className:"dismiss",onClick:l,children:"Ocultar este botón"})]}),e.jsx("button",{className:`crisis-fab ${i?"open":""}`,onClick:()=>r(m=>!m),title:"Apoyo inmediato","aria-label":"Abrir apoyo inmediato",children:"🆘"}),e.jsx("style",{children:`
      ...
      `})]})}const Ee="https://knblatuzbgzgnugwkxdp.supabase.co",re="sb_publishable_yBtfhxGitkJdS9jXO4CGxg_qmMkg3RF",k=!!re,_=k?pe(Ee,re,{auth:{persistSession:!0,autoRefreshToken:!0,storageKey:"sintonia.auth"}}):null,Y="sintonia.webinar_dismissed_",Ce=24;function Ae(){const{student:a}=F(),s=z(),[n,i]=t.useState(null),[r,c]=t.useState(!1),[l,m]=t.useState(!1),[h,g]=t.useState(!1),d=["/admin","/evaluacion","/consentimiento"].some(N=>s.pathname.startsWith(N));t.useEffect(()=>{k&&(async()=>{const{data:N}=await _.from("view_upcoming_webinars").select("*").order("starts_at").limit(1).maybeSingle();if(N){try{const C=localStorage.getItem(Y+N.id);if(C){const T=Number(C);if(Date.now()-T<Ce*3600*1e3)return}}catch{}i(N),setTimeout(()=>c(!0),2500)}})()},[]),t.useEffect(()=>{!n||!(a!=null&&a.code)||_.from("event_rsvp").select("id").eq("event_id",n.id).eq("anonymous_code",a.code).maybeSingle().then(({data:N})=>g(!!N))},[n,a==null?void 0:a.code]);function o(){if(n!=null&&n.id)try{localStorage.setItem(Y+n.id,String(Date.now()))}catch{}c(!1)}async function x(){if(!(a!=null&&a.code)){window.location.assign("/sintonia-unam/mi-historia");return}m(!0),await _.from("event_rsvp").upsert({event_id:n.id,anonymous_code:a.code},{onConflict:"event_id,anonymous_code"}),g(!0),m(!1)}if(!n||d)return null;const w=new Date(n.starts_at).toLocaleString("es-MX",{weekday:"long",day:"2-digit",month:"long",hour:"2-digit",minute:"2-digit"});return e.jsxs(e.Fragment,{children:[!r&&e.jsxs("button",{className:"webinar-pill",onClick:()=>c(!0),"aria-label":"Abrir aviso de webinar",children:["📡 ",e.jsx("span",{children:"Webinar próximo"})]}),r&&e.jsxs("div",{className:"webinar-toast",role:"dialog","aria-label":"Próximo webinar",children:[e.jsx("button",{className:"dismiss-btn",onClick:o,"aria-label":"Cerrar",children:"✕"}),n.image_url&&e.jsx("img",{src:n.image_url,alt:"",className:"webinar-img"}),e.jsxs("div",{className:"webinar-body",children:[e.jsx("span",{className:"webinar-tag",children:"📡 Próximo webinar"}),e.jsx("h3",{children:n.title}),n.speaker&&e.jsxs("small",{children:["👤 ",n.speaker]}),e.jsxs("small",{children:["🗓 ",w]}),n.location&&e.jsxs("small",{children:["📍 ",n.location]}),n.description&&e.jsx("p",{className:"webinar-desc",children:n.description}),e.jsxs("div",{className:"webinar-actions",children:[h?e.jsx("span",{className:"rsvped-chip",children:"✓ Apuntado(a)"}):e.jsx("button",{className:"btn btn-primary btn-sm",onClick:x,disabled:l,children:l?"…":a!=null&&a.code?"✋ Me interesa":"✋ Crear código y apuntarme"}),n.url&&e.jsx("a",{href:n.url,target:"_blank",rel:"noopener noreferrer",className:"btn btn-ghost btn-sm",children:"Más info →"})]})]})]}),e.jsx("style",{children:`
        .webinar-pill {
          position: fixed;
          bottom: 86px;
          right: 20px;
      ...
      `})]})}function qe(){const a=t.useRef(null);return t.useEffect(()=>{if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;let n=null;function i(){if(!a.current)return;const c=window.scrollY;a.current.style.transform=`translate3d(0, ${c*-.1}px, 0)`,n=null}function r(){n==null&&(n=requestAnimationFrame(i))}return i(),window.addEventListener("scroll",r,{passive:!0}),()=>{window.removeEventListener("scroll",r),n&&cancelAnimationFrame(n)}},[]),e.jsxs("div",{ref:a,className:"wellness-bg","aria-hidden":"true",children:[e.jsx("div",{className:"bg-wash"}),e.jsx("div",{className:"bg-blob bg-blob-lavender"}),e.jsx("div",{className:"bg-blob bg-blob-sage"}),e.jsx("div",{className:"bg-blob bg-blob-gold"}),e.jsx("div",{className:"bg-blob bg-blob-coral"}),e.jsx("div",{className:"bg-blob bg-blob-blue"}),e.jsx("style",{children:`
        .wellness-bg {
          position: fixed;
      ...
      `})]}):null}function Te(){const{student:a}=F(),[s,n]=t.useState(null),[i,r]=t.useState(!1);t.useEffect(()=>{_.from("student_library").select("id, title, body").eq("category","challenge").eq("active",!0).then(({data:l})=>n(te(l)))},[]),t.useEffect(()=>{if(!s||!(a!=null&&a.code))return;const l=`challenge_${M()}_${s.id}`;_.from("student_achievements").select("id").eq("anonymous_code",a.code).eq("achievement_key",l).maybeSingle().then(({data:m})=>r(!!m))},[s,a==null?void 0:a.code]);async function c(){if(!(a!=null&&a.code)||!s)return;const l=`challenge_${M()}_${s.id}`;await _.from("student_achievements").upsert({anonymous_code:a.code,achievement_key:l}),r(!0)}return s?e.jsxs("div",{className:"daily-challenge",children:[e.jsx("small",{children:"🎯 Reto del día"}),e.jsx("h3",{children:s.title}),s.body&&e.jsx("p",{children:s.body}),(a==null?void 0:a.code)&&e.jsx("button",{className:`btn ${i?"btn-ghost":"btn-coral"} btn-sm`,onClick:c,disabled:i,children:i?"✓ ¡Lo hiciste!":"Marcar como hecho"}),e.jsx("style",{children:`
        .daily-challenge {
      ...
      `})]})}function Ze({result:a}){if(!a)return null;const{total_score:s,general_level_label:n,anonymous_code:i,ai:r}=a;return e.jsx("section",{className:"result-card",children:e.jsxs("div",{className:"result-hero",children:[e.jsxs("div",{className:"result-score",children:[e.jsx("span",{className:"result-score-num",children:s}),e.jsx("span",{className:"result-score-label",children:"/ 100"})]}),e.jsxs("div",{className:"result-meta",children:[e.jsx("span",{className:"tag",children:"Tu orientación"}),e.jsx("h1",{className:"mt-2",children:n}),e.jsx("p",{className:"result-summary",children:(r==null?void 0:r.friendly_summary)||"Tus respuestas sugieren áreas en las que vale la pena enfocar tu autocuidado durante las próximas semanas. Recuerda que esto es una orientación, no un diagnóstico."}),i&&e.jsxs("p",{className:"anon-code",children:["Tu código anónimo: ",e.jsx("strong",{children:i}),e.jsx("small",{children:"Puedes copiarlo si quieres consultar tu resultado nuevamente más tarde."})]})]})]})})}function ea({dimensions:a}){const s=Object.entries(a);return e.jsx("div",{className:"dim-chart",role:"list",children:s.map(([n,i])=>e.jsxs("div",{className:"dim-row",role:"listitem",children:[e.jsx("div",{className:"dim-label",children:i.label}),e.jsx("div",{className:"dim-track","aria-label":`Puntaje ${i.score} de 100`,children:e.jsx("span",{className:`dim-fill lvl-bg-${i.level}`,style:{width:`${i.score}%`}})}),e.jsxs("div",{className:`dim-value lvl-${i.level}`,children:[i.score,e.jsx("small",{children:P[i.level]})]})]},n))})}function aa({sessionId:a}){const[s,n]=t.useState(0),[i,r]=t.useState(0),[c,l]=t.useState(""),[m,h]=t.useState(!1),[g,p]=t.useState(!1);async function d(){if(s!==0){if(p(!0),k)try{await _.from("assessment_feedback").insert({session_id:a||null,rating:s,comment:c.trim()||null})}catch(o){console.warn(o)}h(!0),p(!1)}}return m?e.jsx("div",{className:"feedback-thanks",children:e.jsxs("p",{children:["✨ ",e.jsx("strong",{children:"Gracias por tu retroalimentación."})," Nos ayuda a mejorar el programa."]})}):e.jsxs("div",{className:"feedback-box",children:[e.jsx("h3",{children:"¿Cómo te pareció esta orientación?"}),e.jsx("div",{className:"stars",role:"radiogroup","aria-label":"Calificación",children:[1,2,3,4,5].map(o=>e.jsx("button",{type:"button",role:"radio","aria-checked":s===o,className:`star ${(i||s)>=o?"active":""}`,onMouseEnter:()=>r(o),onMouseLeave:()=>r(0),onClick:()=>n(o),children:"★"},o))}),e.jsx("textarea",{placeholder:"Comentario opcional…",value:c,onChange:o=>l(o.target.value),rows:2}),e.jsx("button",{className:"btn btn-primary btn-sm",disabled:s===0||g,onClick:d,children:g?"Enviando…":"Enviar"}),e.jsx("style",{children:`
        .feedback-box {
...
`);(w=navigator.clipboard)==null||w.writeText(o).catch(()=>{})}return e.jsxs("section",{className:"section",children:[e.jsxs("div",{className:"container",style:{maxWidth:1e3},children:[e.jsx(Ze,{result:s}),s.general_level==="prioritario"&&e.jsxs("div",{className:"crisis-banner",children:[e.jsx("strong",{children:"📞 Tus respuestas sugieren acercarte a apoyo profesional."}),e.jsxs("p",{children:["Hay servicios universitarios y la ",e.jsx("strong",{children:"Línea de la Vida 800 290 0024"})," disponibles 24/7."]}),e.jsx(b,{to:"/apoyo",className:"btn btn-coral btn-sm",children:"Ver opciones de apoyo →"})]}),e.jsxs("div",{className:"route-cta mt-3",children:[e.jsxs("div",{children:[e.jsx("strong",{children:"✨ Crea tu ruta de bienestar"}),e.jsx("small",{children:"Pum-AI te puede generar un plan diario de 7 o 14 días personalizado a tu resultado."})]}),e.jsx(b,{to:"/ruta",className:"btn btn-gold",children:"Comenzar mi ruta →"})]}),e.jsx(I,{children:c||e.jsxs(e.Fragment,{children:[e.jsx("strong",{children:"Esta orientación es informativa."})," Tus respuestas sugieren áreas en las que vale la pena enfocar tu autocuidado, pero no constituyen un diagnóstico clínico. Si lo necesitas, acércate a un servicio de orientación universitario."]})}),e.jsxs("div",{className:"results-grid mt-4",children:[e.jsxs("div",{className:"panel",children:[e.jsx("span",{className:"tag azul",children:"Tus dimensiones"}),e.jsx("h2",{className:"mt-2",children:"Cómo se ve tu bienestar por área"}),e.jsx("p",{className:"lede",children:"Cada barra representa el nivel de atención que sugieren tus respuestas en esa área. Mayor puntaje = mayor invitación al autocuidado."}),e.jsx(ea,{dimensions:s.dimensions})]}),e.jsxs("div",{className:"panel",children:[e.jsx("span",{className:"tag coral",children:"Acciones sugeridas"}),e.jsx("h2",{className:"mt-2",children:"Pasos pequeños y útiles"}),i.length>0?e.jsx("ul",{className:"rec-list",children:i.map((o,x)=>e.jsxs("li",{children:["✦ ",o]},x))}):e.jsxs("ul",{className:"rec-list",children:[l.length===0&&e.jsx("li",{children:"Sigue cultivando tus rutinas de bienestar. Tus respuestas no muestran áreas urgentes hoy."}),l.map((o,x)=>e.jsxs("li",{children:[e.jsxs("strong",{children:[o.title,"."]})," ",o.description]},x))]})]})]}),e.jsxs("div",{className:"panel mt-4",children:[e.jsx("span",{className:"tag sage",children:"Recursos sugeridos"}),e.jsx("h2",{className:"mt-2",children:"Recursos universitarios para ti"}),r.length>0?e.jsx("ul",{className:"rec-list",children:r.map((o,x)=>e.jsxs("li",{children:["📌 ",o]},x))}):e.jsxs("p",{children:["Visita la sección de ",e.jsx(b,{to:"/recursos",children:"Recursos de apoyo"})," para ver el catálogo completo."]})]}),((d=s.top_attention_areas)==null?void 0:d.length)>0&&e.jsxs("div",{className:"panel mt-4",children:[e.jsx("span",{className:"tag",children:"Áreas con mayor atención sugerida"}),e.jsx("h2",{className:"mt-2",children:"Dónde poner foco"}),e.jsx("ul",{className:"rec-list",children:s.top_attention_areas.map(o=>e.jsxs("li",{children:[e.jsx("strong",{children:o.label})," — Puntaje: ",o.score,", nivel: ",o.level==="prioritario"?"prioritario":"moderado","."]},o.id))})]}),e.jsx(aa,{sessionId:s.session_id}),e.jsxs("div",{className:"results-actions mt-4",children:[e.jsx("button",{className:"btn btn-gold",onClick:m,children:"📋 Copiar resultado"}),e.jsx(b,{to:"/recursos",className:"btn btn-secondary btn-primary",children:"Ver recursos universitarios"}),e.jsx(b,{to:"/evaluacion",className:"btn btn-ghost",children:"Volver a evaluar"}),e.jsx(b,{to:"/",className:"btn btn-ghost",children:"Ir al inicio"})]})]}),e.jsx("style",{children:`
      ...
      `})]})}const na=t.lazy(()=>j(()=>import("./Resources-acdIO3RF.js"),__vite__mapDeps([0,1,2,3]))),ia=t.lazy(()=>j(()=>import("./Privacy-C0AXB575.js"),__vite__mapDeps([4,1,2]))),ra=t.lazy(()=>j(()=>import("./MyHistory-65hILQhN.js"),__vite__mapDeps([5,1,2]))),ta=t.lazy(()=>j(()=>import("./CheckIn-Bx7mJo9t.js"),__vite__mapDeps([6,1,2]))),oa=t.lazy(()=>j(()=>import("./Journal-rM0wYpq2.js"),__vite__mapDeps([7,1,2]))),ca=t.lazy(()=>j(()=>import("./Support-D5nDet55.js"),__vite__mapDeps([8,1,2]))),la=t.lazy(()=>j(()=>import("./WellnessRoute-dL5qfDI0.js"),__vite__mapDeps([9,1,2]))),da=t.lazy(()=>j(()=>import("./Companion-C--4E5Uu.js"),__vite__mapDeps([10,1,2]))),ua=t.lazy(()=>j(()=>import("./Library-0wQantDd.js"),__vite__mapDeps([11,1,2]))),ma=t.lazy(()=>j(()=>import("./Emotions-Qcu8i-Hb.js"),__vite__mapDeps([12,1,2]))),pa=t.lazy(()=>j(()=>import("./MapPage-BDp0bkLU.js"),__vite__mapDeps([13,1,2]))),xa=t.lazy(()=>j(()=>import("./Trees-EBaRqvyN.js"),__vite__mapDeps([14,1,2]))),ha=t.lazy(()=>j(()=>import("./Buddy-1gl-mPoH.js"),__vite__mapDeps([15,1,2]))),ga=t.lazy(()=>j(()=>import("./Adventure-CizRmoSo.js"),__vite__mapDeps([16,1,2]))),va=t.lazy(()=>j(()=>import("./Calendar-Q5A3TU8-.js"),__vite__mapDeps([17,1,2]))),ba=t.lazy(()=>j(()=>import("./Admin-KYBcn7XJ.js"),__vite__mapDeps([18,1,19,2]))),fa=t.lazy(()=>j(()=>import("./AdminLogin-BZYusDRO.js"),__vite__mapDeps([20,1,19,2])));function ja(){return e.jsx("div",{style:{display:"grid",placeItems:"center",minHeight:"40vh"},children:e.jsx("div",{className:"spinner"})})}function ya(){const a=z(),s=a.pathname.startsWith("/admin"),n=!s&&a.pathname!=="/evaluacion";return e.jsxs(e.Fragment,{children:[n&&e.jsx(qe,{}),!s&&e.jsx(we,{}),e.jsx("main",{children:e.jsx(t.Suspense,{fallback:e.jsx(ja,{}),children:e.jsxs(de,{children:[e.jsx(v,{path:"/",element:e.jsx(Le,{})}),e.jsx(v,{path:"/consentimiento",element:e.jsx(Pe,{})}),e.jsx(v,{path:"/evaluacion",element:e.jsx(Xe,{})}),e.jsx(v,{path:"/resultado",element:e.jsx(sa,{})}),e.jsx(v,{path:"/recursos",element:e.jsx(na,{})}),e.jsx(v,{path:"/privacidad",element:e.jsx(ia,{})}),e.jsx(v,{path:"/mi-historia",element:e.jsx(ra,{})}),e.jsx(v,{path:"/check-in",element:e.jsx(ta,{})}),e.jsx(v,{path:"/diario",element:e.jsx(oa,{})}),e.jsx(v,{path:"/apoyo",element:e.jsx(ca,{})}),e.jsx(v,{path:"/ruta",element:e.jsx(la,{})}),e.jsx(v,{path:"/companion",element:e.jsx(da,{})}),e.jsx(v,{path:"/biblioteca",element:e.jsx(ua,{})}),e.jsx(v,{path:"/emociones",element:e.jsx(ma,{})}),e.jsx(v,{path:"/mapa",element:e.jsx(pa,{})}),e.jsx(v,{path:"/arboles",element:e.jsx(xa,{})}),e.jsx(v,{path:"/buddy",element:e.jsx(ha,{})}),e.jsx(v,{path:"/aventura",element:e.jsx(ga,{})}),e.jsx(v,{path:"/calendario",element:e.jsx(va,{})}),e.jsx(v,{path:"/docentes",element:e.jsx(B,{to:"/admin/login",replace:!0})}),e.jsx(v,{path:"/admin/login",element:e.jsx(fa,{})}),e.jsx(v,{path:"/admin/*",element:e.jsx(ba,{})}),e.jsx(v,{path:"*",element:e.jsx(B,{to:"/",replace:!0})})]})})}),!s&&e.jsx(Se,{}),!s&&e.jsx(ke,{}),!s&&e.jsx(Ae,{})]})}(function(){const s=new URLSearchParams(window.location.search),n=s.get("p");if(n!==null){const i=s.get("q"),r=window.location.pathname.replace(/\/$/,"")+n+(i?"?"+i.replace(/~and~/g,"&"):"")+window.location.hash;window.history.replaceState(null,"",r)}})();const _a="/sintonia-unam/".replace(/\/$/,"");ne(document.getElementById("root")).render(e.jsx(ue.StrictMode,{children:e.jsx(me,{basename:_a,children:e.jsx(ya,{})})}));export{Q as D,Sa as R,I as S,_e as a,S as b,Ne as c,Ea as d,Ca as e,ka as f,J as g,k as i,e as j,_ as s,F as u};
