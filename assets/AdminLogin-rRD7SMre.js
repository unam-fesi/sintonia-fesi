import{j as a}from"./index-SuBsTpar.js";import{b as g,r as t,L as h}from"./vendor-react-BTW_75ak.js";import{g as m,a as f}from"./authService-BSxV27o7.js";import"./vendor-supabase-DS4euJVY.js";function S(){const i=g(),[n,p]=t.useState(""),[s,u]=t.useState(""),[o,r]=t.useState(null),[l,c]=t.useState(!1);t.useEffect(()=>{(async()=>await m().catch(()=>null)&&i("/admin",{replace:!0}))()},[i]);async function x(e){e.preventDefault(),r(null),c(!0);try{if(await f(n.trim(),s),!await m()){r("Esta cuenta no tiene permisos administrativos.");return}i("/admin",{replace:!0})}catch(d){r(d.message||"Credenciales incorrectas.")}finally{c(!1)}}return a.jsxs("section",{className:"login-shell",children:[a.jsxs("div",{className:"login-card",children:[a.jsx("img",{src:"/sintonia-fesi/Sintonia-icon192.png",srcSet:"/sintonia-fesi/Sintonia-icon192.png 1x, /sintonia-fesi/Sintonia-icon512.png 2x",alt:"Sintonía FES Iztacala",className:"login-mark",width:"72",height:"72"}),a.jsx("h1",{children:"Acceso interno"}),a.jsx("p",{className:"lede text-center",children:"Panel administrativo · Sintonía FES Iztacala"}),o&&a.jsx("div",{className:"login-error",children:o}),a.jsxs("form",{onSubmit:x,autoComplete:"off",children:[a.jsxs("div",{className:"field",children:[a.jsx("label",{htmlFor:"email",children:"Correo institucional"}),a.jsx("input",{id:"email",type:"email",required:!0,autoComplete:"username",value:n,onChange:e=>p(e.target.value),placeholder:"usuario@unam.mx"})]}),a.jsxs("div",{className:"field",children:[a.jsx("label",{htmlFor:"password",children:"Contraseña"}),a.jsx("input",{id:"password",type:"password",required:!0,autoComplete:"current-password",value:s,onChange:e=>u(e.target.value)})]}),a.jsx("button",{type:"submit",className:"btn btn-primary",style:{width:"100%"},disabled:l,children:l?"Verificando…":"Iniciar sesión"})]}),a.jsx("p",{className:"note text-center mt-3",children:"Solo personal autorizado. Si tu cuenta no aparece, contacta a la coordinación del programa."}),a.jsx("p",{className:"text-center mt-2",children:a.jsx(h,{to:"/",className:"note",children:"← Volver al sitio público"})})]}),a.jsx("style",{children:`
        .login-shell {
          min-height: 100vh;
          display: grid;
          place-items: center;
